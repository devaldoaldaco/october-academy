...
//Funcion para sacar el balance de cada persona por sus transferencias
function transactionBalance(person) {
    const { credit, debit } = person.transactions.reduce(
        (acc, t) => {
        acc[t.type] += t.amount;
        return acc;
        },
...
//Funcion principal para mostrar cada persona con su balance personal, ordenado de menor a mayor
